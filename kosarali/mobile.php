  ...
  <?php include('header.php'); ?>
    ...
    <div class="container my-5">
      <div class="row mt-4 g-4 d-flex justify-content-center">
        <div class="col-md-4">
          <div class="btn text-center text-white">
            <a href="http://localhost/kosarali/portfolio.php" class="btn btn-bg-warning btn-outline-warning btn-sm "><h4>Web Development Projects</h4></a>
          </div>
        </div>
        <div class="col-md-4">
          <div class="btn text-center">
            <a href="http://localhost/kosarali/mobile.php" class="btn btn-bg-warning btn-outline-warning btn-sm active"><h4>Mobile Development Projects</h4></a>
          </div>
        </div>
        <div class="col-md-4">
          <div class="btn text-center">
      ...
      <div class="text-center mt-5">
        <a href="mobile_more.php" class="btn btn-outline-secondary">View All Projects</a>
      </div>
    </div>
