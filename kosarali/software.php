  ...
  <?php include('header.php'); ?>
    ...
    <div class="container my-5">
      <div class="row mt-4 g-4 d-flex justify-content-center">
        ...
        <div class="col-md-4">
          <div class="btn text-center">
            <a href="http://localhost/kosarali/software.php" class="btn btn-outline-warning btn-sm active"><h4>Software Development Projects</h4></a>
          </div>
        </div>
      </div>
      ...
      <div class="text-center mt-5">
        <a href="sf_more.php" class="btn btn-outline-secondary">View All Projects</a>
      </div>
    </div>
